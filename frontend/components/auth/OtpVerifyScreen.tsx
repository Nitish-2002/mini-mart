...
// code and "no registration exists yet for this email" get the identical
// 401 invalid_code response (services.py's InvalidCode) — this screen
// cannot and does not try to tell the two apart, by design.
interface OtpVerifyScreenProps {
  role: "end_user" | "delivery_agent";
  homePath: string;
}

function VerifyForm({ role, homePath }: OtpVerifyScreenProps) {
...
export function OtpVerifyScreen(props: OtpVerifyScreenProps) {
  return (
